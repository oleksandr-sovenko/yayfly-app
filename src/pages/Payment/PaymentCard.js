        ...
        <div>
            <CardWrap sx={{ marginTop: { md: "40px", xs: "20px" }, boxShadow: { md: "rgb(101 101 101 / 5%) 4px 4px 12px", xs: "none" } }}>
                <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gap={2} sx={{ gridAutoFlow: "dense" }}>
                    <Box sx={{ order: { md: "inherit", xs: 2 }, gridColumn: { md: "span 7", xs: "span 12" }, padding: { md: "40px 0px 0px 35px", xs: "20px 15px 0px" } }}>
                    ...
                    <Box sx={{ gridColumn: { md: "span 5", xs: "span 12" }, background: { md: "none", xs: "#F2F3F7" }, padding: { md: "40px 35px 0px 0px", xs: "0px" }, marginBottom: { xs: "20px", md: "0px" } }}>
