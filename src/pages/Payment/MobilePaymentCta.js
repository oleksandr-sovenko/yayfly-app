        ...
        <div>
            <Box className="mobile-payment-cta">
                ...
                >
                    ...
                    <Grid container sx={{ placeItems: "center", alignItems: {md:"center", xs:"flex-start"} }}>
                        <Grid item xs={8} sm={7}>
                            <Typography sx={{ color: "#fff", fontFamily: "'Jaldi', sans-serif", fontSize: {md:"18px",xs:"17px"}, fontWeight: 600 }}>
                                Our search results detected an unpublished deal for your flight.
                            </Typography>
                        </Grid>
                        <Grid item xs={4} sm={5} sx={{ textAlign: "end", "& img":{ height:{md:"", xs:"88px"} } }}>
                            <img src={ctaCartoon} alt="" />
                        </Grid>
                    </Grid>
                    <Box sx={{ marginTop: {md:"0px", xs:"-20px"}, "& a":{ borderRadius: {md:"50px", xs:"0px"} }}}>
                        <Typography sx={{ color: "#fff", fontSize: {md:"16px", xs:"17px"}, marginBottom: "7px", fontWeight: 600, }}>
                            Call now&nbsp; 
                            <Typography component="span" sx={{fontSize: {md:"16px", xs:"17px"}}}>
                                to secure the best fare
                            </Typography>{" "}
                        </Typography>
                        <a href={`tel:${phone.replace(/[^0-9]/g, '')}`} style={{ display: "inline-block", background: "#12172a", width: "216px", lineHeight: "42px", height: "42px", fontSize: "22px", color: "#fff", textDecoration: "none", fontFamily: "Jaldi", fontWeight: 700, boxSizing: "border-box", textAlign: "center", transition: "all 0.3s ease 0s" }}>
                            {" "}
                            ...
                            <Typography component="span" sx={{fontWeight: 700, fontSize: "18px",}}>{phone}</Typography>
                        </a>
                        <Typography sx={{ fontSize: "14px", color: "#fff", marginTop: "5px", textAlign: "center", fontWeight: 600, fontFamily: "'Jaldi', sans-serif", width: {md:"100%", xs:"216px"} }}>
